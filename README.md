...
To use the library no further dependencies are necessary. The main parts of the library should work with Mathematica 12.2 or newer.
In case the interface to the C++ code is to be used, Mathematica 13.3 or newer is required.
